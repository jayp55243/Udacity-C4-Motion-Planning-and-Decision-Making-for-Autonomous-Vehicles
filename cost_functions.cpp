    ...
    for (size_t c = 0; c < n_circles && !collision; ++c) {
      ...
      for (auto obst : obstacles) {
        ...
        for (size_t c2 = 0; c2 < n_circles && !collision; ++c2) {
          ...
          // obstacle/actor
          double x_square = std::pow((circle_center_x - actor_center_x), 2);
          double y_square = std::pow((circle_center_y - actor_center_y), 2);
          
          double dist = std::sqrt(x_square + y_square);  // <- Update
